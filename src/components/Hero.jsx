...
const Hero = () => {
	return (
		<div
			className="flex md:flex-row flex-col justify-between items-center gap-10 md:gap-10 lg:gap-28 max-w-7xl mx-auto px-10 py-20"
			id="hero"
		>
			<div className=" flex flex-col justify-center md:items-start items-center text-center md:text-left gap-4">
				...
				<div>
					...
					<div className="flex flex-row justify-start items-center gap-1.5">
						<img src={tick} alt="tick" className="w-5" />
						<span className="text-[20px] font-semibold">No Upfront Costs</span>
					</div>
				</div>
			</div>
